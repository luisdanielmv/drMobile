(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    noneResultsText: 'No results match for',
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      var searchbox = this.options.liveSearch ? '<div class="bootstrap-select-searchbox"><input type="text" class="input-block-level form-control" autocomplete="off" placeholder="Quick search"/></div>' : '';
